...
|2  |**As a chance visitor** <br> I want to experience a user-friendly interface and clear navigation highlighting the quiz options; also ensuring that I can repeat the quiz easily to improve my score. <br> **I know I can do it when the site has visually ordered graphics, with all the buttons responding to the mouse cursor poining at them and a button in the end of the quiz that lets you repeat the game.** |Pass|![End of quiz screenshot](docs/features-screenshots/End_quiz.png)![Play Agian button hover function](docs/features-screenshots/startagain_function.jpg)|Evidence|
